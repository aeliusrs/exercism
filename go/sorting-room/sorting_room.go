...
type FancyNumber struct { n string }

func (i FancyNumber) Value() string { return i.n }

type FancyNumberBox interface { Value() string }
...
func DescribeFancyNumberBox(fnb FancyNumberBox) string {
	...
	float32(ExtractFancyNumber(fnb)))
}
...
func DescribeAnything(i interface{}) string {
	switch v := i.(type) {
		...
		case float64: return DescribeNumber(v)
